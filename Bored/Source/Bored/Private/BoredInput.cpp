...
UBoredInput::UBoredInput(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
	, PrevTouchState(0)
{
}

void UBoredInput::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void UBoredInput::ProcessKeyStates(float DeltaTime)
{
...
void UBoredInput::UpdateGameKeys(float DeltaTime)
{
	ABoredPlayerController* MyController = CastChecked<ABoredPlayerController>(GetOuter());
...
void UBoredInput::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void UBoredInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D UBoredInput::GetTouchAnchor(int32 i) const
{
