...
#include "BoredCameraComponent.generated.h"

/**
 * 
 */
UCLASS(config = Game, BlueprintType, HideCategories = Trigger, meta = (BlueprintSpawnableComponent))
class BORED_API UBoredCameraComponent : public UCameraComponent
{
...
public:
	...
	* @param	DownTime			Time pressed
	*/
	void OnPinchUpdate(class UBoredInput* InputHandler, const FVector2D& ScreenPosition1, const FVector2D& ScreenPosition2, float DownTime);
